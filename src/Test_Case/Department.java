...
public class Department {
	...
	public static void main(String[] args)  {
        ...
        driver.findElement(By.xpath("//button[@href='#/department']")).click();
        ...
        driver.findElement(By.xpath("//input[@formcontrolname='code']")).sendKeys("10004");
        driver.findElement(By.xpath("//input[@formcontrolname='label']")).sendKeys("Test_Auto");
        driver.findElement(By.xpath("//input[@formcontrolname='label_lcl']")).sendKeys("Test_Auto");
