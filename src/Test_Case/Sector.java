...
public class Sector {
	...
	public static void main(String[] args)  {
        ...
        driver.findElement(By.xpath("//a[@href='#/sector']")).click();
        ...
        driver.findElement(By.xpath("//input[@formcontrolname='code']")).sendKeys("10005");
        
        driver.findElement(By.xpath("//input[@formcontrolname='label']")).sendKeys("Test_Auto_Sector");
        
        driver.findElement(By.xpath("//input[@formcontrolname='label_lcl']")).sendKeys("Test_Auto_Sector");
        
        driver.findElement(By.xpath("//input[@formcontrolname='parent']")).sendKeys("10008");
