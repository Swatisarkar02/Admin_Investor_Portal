...
public class Team {
	...
	public static void main(String[] args)  {
        ...
        driver.findElement(By.xpath("//input[@formcontrolname='name_en']")).sendKeys("Auto_Team_1");
        driver.findElement(By.xpath("//input[@formcontrolname='name_lcl']")).sendKeys("Auto_Team_1");
        
        Select dMl = new Select (driver.findElement(By.xpath("//select[@formcontrolname='department']")));
        dMl.selectByVisibleText(" Testing ");
