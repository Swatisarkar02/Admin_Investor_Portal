...
public class Role {
	...
	public static void main(String[] args)  {
        ...
        driver.findElement(By.xpath("//a[@href='#/role']")).click();
        ...
        driver.findElement(By.xpath("//input[@formcontrolname='code']")).sendKeys("1003");
        driver.findElement(By.xpath("//input[@formcontrolname='label']")).sendKeys("Test_Auto_Role");
        driver.findElement(By.xpath("//input[@formcontrolname='label_lcl']")).sendKeys("Test_Auto_Role");
