...
public class Page {
	...
	public static void main(String[] args)  {
        ...
        driver.findElement(By.xpath("//input[@formcontrolname='name_en']")).sendKeys("Auto_Page");
        driver.findElement(By.xpath("//input[@formcontrolname='name_lcl']")).sendKeys("Auto_Page");
        
        driver.findElement(By.xpath("//input[@formcontrolname='title_en']")).sendKeys("Auto_Title");
        driver.findElement(By.xpath("//input[@formcontrolname='title_lcl']")).sendKeys("Auto_Title");
