...
public class Salutation {
	...
	public static void main(String[] args)  {
        ...
        driver.findElement(By.xpath("//a[@href='#/salutation']")).click();
        ...
        driver.findElement(By.xpath("//input[@formcontrolname='code']")).sendKeys("10003");
        driver.findElement(By.xpath("//input[@formcontrolname='label']")).sendKeys("Test_Mr");
        driver.findElement(By.xpath("//input[@formcontrolname='label_lcl']")).sendKeys("Test_Mr");
